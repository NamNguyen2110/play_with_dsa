...
namespace Ntp
{
	class Program
	{
		static void Main(string[] args)
		{
			try
			{
				ExamForNtp exam = new ExamforNtp();
				...
				long T4 = exam.GetNtpMessage();
				DateTime OriginateReceiveTimestamp = new DateTime(T4); //T4
				...
				exam.Submit("username","password","ExamId","QuestionId","","OriginateSendTimestamp","ReceiveTimestamp","TransmitTimestamp","OriginateReceiveTimestamp","Theta","FinalDateTime");
			}
			catch (Exception e)
			{
